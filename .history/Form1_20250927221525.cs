...
namespace THOITIET
{
    ...
    public partial class Form1 : Form
    {
        ...
        private PictureBox? hinhNenChinh;
        private Chart? bieuDoNhietDo;
        private WebView2? banDoGio;
        private TabControl? tabBieuDoBanDo;
        ...
        // Giao diện phân đoạn runtime (không dùng nữa khi có UnitToggle designer)
        // Các biến btnC, btnF, donViSegment đã được xóa vì giờ dùng UnitToggle trong Designer
        
        // Lưu địa điểm
        private int chiSoDiaDiemHienTai = 0;

        public Form1()
        {
            System.Diagnostics.Debug.WriteLine("=== BẮT ĐẦU CONSTRUCTOR FORM1 ===");
            InitializeComponent();
            CauHinhKhoiTao();
            ApDungStyleGlassmorphism();

            // Không tạo giao diện phân đoạn runtime nữa (đã có UnitToggle trong Designer)
            ...
            unitToggle.DonViThayDoi += async (sender, laCelsius) => {
                ...
                System.Diagnostics.Debug.WriteLine($"UnitToggle đã thay đổi thành: {(laCelsius ? "Celsius" : "Fahrenheit")}");
                if (weatherData != null)
            ...
            {
                System.Diagnostics.Debug.WriteLine($"Lỗi tạo file địa điểm: {ex.Message}");
            }
            ...
            System.Diagnostics.Debug.WriteLine("Đang gọi SetDefaultBackgroundOnStartup...");
            ...
            // Xóa gợi ý tìm kiếm
            System.Diagnostics.Debug.WriteLine("=== KẾT THÚC CONSTRUCTOR FORM1 ===");
        }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            System.Diagnostics.Debug.WriteLine("=== KẾT THÚC FORM1_LOAD ===");
        }
