...
namespace THOITIET
{
    ...
    {
        private readonly string API_KEY = CauHinhApi.API_KEY;
        private readonly HttpClient http = new HttpClient();
        private readonly string GOOGLE_API_KEY = CauHinhApi.GEOCODING_API_KEY;
        private readonly string GEOAPIFY_API_KEY = CauHinhApi.GEOAPIFY_API_KEY;
