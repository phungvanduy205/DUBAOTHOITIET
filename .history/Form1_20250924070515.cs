        ...
        private void Show24hChartForDay(DailyWeather daily)
        {
            try
            {
                ...
                var tempSeries = new Series("Nhiệt độ thực tế")
                {
                    ...
                    Color = Color.FromArgb(255, 255, 193, 7), // Màu vàng
                    BorderColor = Color.FromArgb(255, 255, 193, 7),
                    BorderWidth = 1,
                    Legend = legend.Name
                };
                ...
                {
                    ChartType = SeriesChartType.Column,
                    Color = Color.FromArgb(255, 40, 167, 69), // Màu xanh lá
                    BorderColor = Color.FromArgb(255, 40, 167, 69),
                    BorderWidth = 1,
                    Legend = legend.Name
                };
