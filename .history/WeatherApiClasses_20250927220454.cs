...
namespace THOITIET
{
    ...
    public static class CauHinhApi
    {
        ...
        private static string LayKhoaApi(string tenKhoa)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"API Key {tenKhoa} từ biến môi trường: {envValue.Substring(0, 8)}...");
                return envValue;
            }
                ...
                if (File.Exists(configFile))
                {
                    ...
                    foreach (var line in lines)
                    {
                        ...
                        if (line.StartsWith(tenKhoa + "="))
                        {
                            ...
                            System.Diagnostics.Debug.WriteLine($"API Key {tenKhoa} từ file: {key.Substring(0, Math.Min(8, key.Length))}...");
                            return key;
                        }
                    }
                }
