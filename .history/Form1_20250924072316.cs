    ...
    public partial class Form1 : Form
    {
        ...
        private void Show24hChartForDay(DailyWeather daily)
        {
            try
            {
                ...
                // Series 1: Nhiệt độ thực tế (line chart)
                var tempSeries = new Series("Nhiệt độ thực tế")
                {
                    ChartType = SeriesChartType.Line,
                    Color = Color.FromArgb(255, 74, 144, 226), // Màu xanh dương sáng
                    BorderWidth = 3,
        ...
        private void InitializeTemperatureChart()
        {
            try
            {
                ...
                // Tạo ChartArea với style đẹp hơn
                var chartArea = new ChartArea("MainArea")
                {
                    BackColor = Color.FromArgb(20, 30, 40, 50), // Nền tối đẹp
                    BorderColor = Color.FromArgb(100, 255, 255, 255),
                    BorderWidth = 2,
                ...
                // 2. Biểu đồ so sánh hàng ngày
                var comparisonGroup = new GroupBox
                {
                    Location = new Point(10, 320),
                    Size = new Size(tabChart.Width - 30, 200),
                    Font = new Font("Segoe UI", 12F, FontStyle.Bold),
                    ForeColor = Color.White,
                    Text = "So sánh hàng ngày",
                    BackColor = Color.FromArgb(40, 30, 40, 50)
                };
                ...
                // 4. Tổng lượng mưa
                var rainGroup = new GroupBox
                {
                    Location = new Point(10, 740),
                    Size = new Size(tabChart.Width - 30, 150),
                    Font = new Font("Segoe UI", 12F, FontStyle.Bold),
                    ForeColor = Color.White,
                    Text = "Tổng lượng mưa",
                    BackColor = Color.FromArgb(40, 30, 40, 50)
                ...
                // Tạo biểu đồ so sánh hàng ngày
                CreateDailyComparisonChart(comparisonGroup);
                
                // Tạo biểu đồ tỉ lệ mưa
                CreateRainProbabilityChart(rainProbGroup);
                
                // Tạo tổng lượng mưa
                CreateRainfallSummary(rainGroup);
                
                mainPanel.Controls.Add(tempChartGroup);
                mainPanel.Controls.Add(comparisonGroup);
                mainPanel.Controls.Add(rainProbGroup);
                mainPanel.Controls.Add(rainGroup);
