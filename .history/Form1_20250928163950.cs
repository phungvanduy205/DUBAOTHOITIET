...
namespace THOITIET
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void DieuChinhBoCucHienTai()
        {
            try
            {
                // Giãn lưới chi tiết chiếm ~50% chiều cao dưới cùng
                int paddingDuoi = 10;
                int chieuCaoChiTiet = Math.Max(160, khuVucTrai_HienTai.Height / 2);
                detailGridPanel.Height = chieuCaoChiTiet;
                detailGridPanel.Dock = DockStyle.Bottom;
                // Căn icon thời tiết chính sát mép phải, cách 20px
                int iconWidth = anhIconThoiTiet.Width;
                anhIconThoiTiet.Left = Math.Max(0, khuVucTrai_HienTai.ClientSize.Width - iconWidth - 20);
