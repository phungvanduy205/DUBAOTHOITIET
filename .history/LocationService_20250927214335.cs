...
namespace THOITIET
{
    ...
    public class LocationService
    {
        ...
        /// </summary>
        public async Task<(bool success, string location, double lat, double lon, ThoiTietHienTai? weatherData)> SearchLocationAsync(string searchTerm)
        {
            try
            {
                ...
                var lat = location.ViDo;
                var lon = location.KinhDo;
                var locationName = location.TenDayDu;
        ...
        /// </summary>
        public async Task<(bool success, string location, double lat, double lon, ThoiTietHienTai? weatherData)> GetCurrentLocationAsync()
        {
            try
            {
                // Sử dụng tọa độ mặc định (Thái Nguyên) vì không có method lấy IP
                var lat = 21.5941;
                var lon = 105.8432;
                var locationName = "Thái Nguyên, Thái Nguyên, Việt Nam";
    ...
    /// <summary>
    /// Class đại diện cho địa điểm đã lưu
    /// </summary>
