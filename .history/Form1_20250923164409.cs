...
namespace THOITIET
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void PositionHeaderButtons()
        {
            ...
            btnShowMap.Location = new Point(chartBounds.Left + chartBounds.Width - btnShowMap.Width - 10,
                                            chartBounds.Top + 5);
            btnShowChart.Location = new Point(btnShowMap.Left - btnShowChart.Width - 8,
                                              chartBounds.Top + 5);
        }
