...
namespace THOITIET
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void TaoSegmentDonVi()
        {
            try
            {
                ...
                donViSegment = new Panel
                {
                    ...
                    Location = new Point(thanhTrenCung.Width - 100, 10)
                };
                ...
                thanhTrenCung.Controls.Add(donViSegment);
                thanhTrenCung.Resize += (s, e) =>
                {
                    if (donViSegment != null)
                        donViSegment.Location = new Point(thanhTrenCung.Width - donViSegment.Width - 10, 10);
                };
        ...
        private void StyleSearchBarPill()
        {
            try
            {
                if (oTimKiemDiaDiem == null || thanhTrenCung == null) return;
                ...
                searchContainer = new Panel
                {
                    ...
                    Size = new Size(Math.Max(300, thanhTrenCung.Width - 250), 38),
                ...
                thanhTrenCung.Controls.Remove(oTimKiemDiaDiem);
                oTimKiemDiaDiem.BorderStyle = BorderStyle.None;
                ...
                thanhTrenCung.Controls.Add(searchContainer);
                ...
                if (NutTimKiem != null)
                {
                    ...
                    thanhTrenCung.Resize += (s, e) =>
                    {
                        ...
                        {
                            searchContainer.Width = Math.Max(300, thanhTrenCung.Width - 250);
                            oTimKiemDiaDiem.Width = searchContainer.Width - 50;
                            if (NutTimKiem != null)
                                NutTimKiem.Location = new Point(searchContainer.Width - 36, 2);
                        }
