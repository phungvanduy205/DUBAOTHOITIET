    ...
    public static class CauHinhApi
    {
        ...
        private static string LayKhoaApi(string tenKhoa)
        {
            try
            {
                ...
                System.Diagnostics.Debug.WriteLine($"[API DEBUG] Tìm kiếm file .env cho {tenKhoa}:");
                ...
                // Nếu không tìm thấy file .env, hiển thị hướng dẫn
                System.Diagnostics.Debug.WriteLine($"[API DEBUG] Không tìm thấy {tenKhoa} trong file .env");
            ...
            {
                System.Windows.Forms.MessageBox.Show($"Lỗi đọc file .env: {ex.Message}", "Gỡ lỗi", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Error);
            }
