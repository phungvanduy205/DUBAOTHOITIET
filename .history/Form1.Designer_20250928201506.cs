namespace THOITIET
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            thanhTrenCung.Location = new Point(0, 40); // Để lại chỗ cho thanh tiêu đề
            ...
            boCucChinh.Location = new Point(0, 97); // Điều chỉnh để không bị che khuất bởi thanhTrenCung
