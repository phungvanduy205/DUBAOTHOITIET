...
### 📊 Biểu Đồ & Thống Kê
- **Biểu đồ nhiệt độ**: Biểu đồ đường nhiệt độ theo giờ
- **Biểu đồ độ ẩm**: Biểu đồ cột độ ẩm
- **Biểu đồ áp suất**: Biểu đồ áp suất khí quyển
- **Xuất biểu đồ**: Lưu biểu đồ dưới dạng hình ảnh
