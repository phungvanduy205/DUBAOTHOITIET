    ...
    public partial class Form1 : Form
    {
        ...
        private void Show24hChartForDay(DailyWeather daily)
        {
            try
            {
                ...
                temperatureChart.ChartAreas[0].AxisX.LabelStyle.Font = new Font("Segoe UI", 9F, FontStyle.Bold);
                temperatureChart.ChartAreas[0].AxisY.LabelStyle.Font = new Font("Segoe UI", 9F, FontStyle.Bold);
                temperatureChart.Titles[0].Font = new Font("Segoe UI", 14F, FontStyle.Bold);
