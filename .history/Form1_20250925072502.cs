    ...
    public partial class Form1 : Form
    {
        ...
        private void TaoPanelChiTiet(Panel panel, string icon, string title, string value)
        {
            try
            {
                ...
                {
                    Text = title,
                    Font = new Font("Segoe UI", 8F, FontStyle.Regular), // Giảm font size từ 9 xuống 8
                    ForeColor = Color.White,
                    BackColor = Color.Transparent,
                    TextAlign = ContentAlignment.MiddleCenter,
                    Location = new Point(3, 35), // Giảm margin từ 5 xuống 3
                    Size = new Size(panel.Width - 6, 22), // Tăng height lên 22 và giảm margin
