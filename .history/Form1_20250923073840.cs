        ...
        private void TaoSegmentDonViChiF()
        {
            try
            {
                ...
                btnC.Click += async (s, e) => { 
                    if (!donViCelsius) { 
                        donViCelsius = true; 
                        System.Diagnostics.Debug.WriteLine("Chuyển sang độ C");
                        CapNhatUI(); 
                ...
                btnF.Click += async (s, e) => { 
                    if (donViCelsius) { 
                        donViCelsius = false; 
                        System.Diagnostics.Debug.WriteLine("Chuyển sang độ F");
                        CapNhatUI(); 
                        await CapNhatUIKhiChuyenDoiDonVi(); 
                    } 
                };
        ...
        private async Task CapNhatUIKhiChuyenDoiDonVi()
        {
            try
            {
                ...
                if (nhanNhietDoHienTai != null && nhanNhietDoHienTai.Text.Contains("°"))
                {
                    ...
                    if (double.TryParse(currentTempText, out double currentTemp))
                    {
                        var convertedTemp = GetTemperatureInUnit(currentTemp);
                ...
                if (feelsLikePanel != null)
                {
                    ...
                    if (feelsLikeLabel != null && feelsLikeLabel.Text.Contains("°"))
                    {
                        ...
                        {
                            var convertedTemp = GetTemperatureInUnit(temp);
