...
namespace THOITIET
{
    ...
    public class DatabaseHelper
    {
        ...
        {
            // Chuỗi kết nối SQL Server - có thể thay đổi theo cấu hình
            connectionString = "Server=localhost;Database=WeatherDB;Integrated Security=true;TrustServerCertificate=true;";
        }
