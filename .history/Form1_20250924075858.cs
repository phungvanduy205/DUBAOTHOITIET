        ...
        private void Show24hChartForDay(DailyWeather daily)
        {
            try
            {
                ...
                var legend = new Legend
                {
                    ...
                    BackColor = Color.Transparent,
                    Font = new Font("Segoe UI", 10F, FontStyle.Regular),
                    Position = new ElementPosition(10, 85, 80, 10)
                };
                ...
                temperatureChart.ChartAreas[0].AxisX.TitleFont = new Font("Segoe UI", 12, FontStyle.Bold);
                ...
                temperatureChart.ChartAreas[0].AxisX.Interval = 2; // hiện mỗi 2 giờ để rõ hơn
                temperatureChart.ChartAreas[0].AxisX.LabelStyle.Font = new Font("Segoe UI", 10, FontStyle.Bold);
                ...
                // Cấu hình trục Y
                temperatureChart.ChartAreas[0].AxisY.Title = $"°{(donViCelsius ? "C" : "F")}";
        ...
        private void InitializeTemperatureChart()
        {
            try
            {
                ...
                var chartArea = new ChartArea("MainArea")
                {
                    ...
                    InnerPlotPosition = new ElementPosition(5, 20, 90, 75)
                };
