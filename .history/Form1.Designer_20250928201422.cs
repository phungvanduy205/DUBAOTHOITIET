namespace THOITIET
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            thanhTrenCung.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
            thanhTrenCung.Location = new Point(0, 30); // Để lại chỗ cho thanh tiêu đề
            ...
            boCucChinh.Location = new Point(0, 87); // Điều chỉnh để không bị che khuất bởi thanhTrenCung
            ...
            Icon = (Icon)taiNguyen.GetObject("$this.Icon"); // Commented out to fix MissingManifestResourceException
