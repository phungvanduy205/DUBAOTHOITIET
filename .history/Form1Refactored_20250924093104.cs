...
namespace THOITIET
{
    ...
    /// </summary>
    public partial class Form1Refactored : Form
    {
        // Services
        ...
        private async void ShowMap()
        {
            try
            {
                ...
                await mapService.ShowMapAsync(currentLat, currentLon, null); // temperatureChart sẽ được truyền từ Form1
            }
            catch (Exception ex)
            {
        ...
        private void ShowChart()
        {
            try
            {
                mapService.ShowChart(null); // temperatureChart sẽ được truyền từ Form1
            }
            catch (Exception ex)
            {
        ...
        // Giả sử InitializeComponent() đã được tạo trong Designer
        private void InitializeComponent()
        {
            // Code khởi tạo UI controls sẽ được tạo bởi Designer
