    ...
    public partial class Form1 : Form
    {
        ...
        private void TaoPanelDuBaoGioMoi(Panel panel, string icon, string gio, string nhietDo, string trangThai)
        {
            try
            {
                ...
                {
                    Text = nhietDo,
                    Font = new Font("Segoe UI", 22F, FontStyle.Bold), // Font lớn nhất
                    ForeColor = Color.White,
                    BackColor = Color.Transparent,
                    TextAlign = ContentAlignment.MiddleCenter,
                    Location = new Point(5, 30),
                    Size = new Size(panel.Width - 10, 45)
                };
                ...
                {
                    Text = icon,
                    Font = new Font("Segoe UI Emoji", 32F), // Icon to
                    ForeColor = Color.White,
                    BackColor = Color.Transparent,
                    TextAlign = ContentAlignment.MiddleCenter,
                    Location = new Point(5, 115),
                    Size = new Size(panel.Width - 10, 60)
                };
