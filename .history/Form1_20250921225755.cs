    ...
    public partial class Form1 : Form
    {
        ...
        private void TaoPanelDuBaoGioMoi(Panel panel, string icon, string gio, string nhietDo, string trangThai)
        {
            try
            {
                ...
                // Label giờ (trên cùng) - chuyển từ vị trí nhiệt độ
                ...
                // Label trạng thái (giữa panel) - tăng kích thước để không bị đè
                var trangThaiLabel = new Label
                {
                    Text = trangThai,
                    Font = new Font("Segoe UI", 9F),
                    ...
                    Size = new Size(panel.Width - 16, 35)
                };

                // Label nhiệt độ (dưới trạng thái) - chuyển từ vị trí giờ
                var nhietDoLabel = new Label
                {
                    Text = nhietDo,
                ...
                // Label icon (dưới cùng) - tăng kích thước lớn hơn
                var iconLabel = new Label
                {
                    Text = icon,
                    Font = new Font("Segoe UI Emoji", 32F), // Tăng kích thước icon lên 32
                    ForeColor = Color.White,
                    BackColor = Color.Transparent,
                    TextAlign = ContentAlignment.MiddleCenter,
