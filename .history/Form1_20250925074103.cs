            ...
            try
            {
                ...
                if (suggestionPanel == null)
                {
                    suggestionPanel = new Panel
                    {
                        ...
                        BackColor = Color.FromArgb(180, 255, 255, 255), // Nền trắng mờ hơn
                        Size = new Size(600, 35), // Panel rộng hơn và cao hơn
                        Location = new Point(50, 200), // Vị trí giữa màn hình, không bị che
