    ...
    public partial class Form1 : Form
    {
        ...
        private void StyleSearchBarPill()
        {
            try
            {
                ...
                // Di chuyển TextBox vào container
                if (oTimKiemDiaDiem.Parent != null)
                ...
                if (NutTimKiem != null)
                {
                    ...
                    boCucChinh.Resize += (s, e) =>
                    {
                        ...
                        {
                            searchContainer.Width = Math.Max(300, boCucChinh.Width - 250);
                            oTimKiemDiaDiem.Width = searchContainer.Width - 50;
                            if (NutTimKiem != null)
                                NutTimKiem.Location = new Point(searchContainer.Width - 36, 2);
                        }
                ...
                // Đảm bảo pill không bị che bởi segment °C/°F
