namespace THOITIET
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            congTacDonVi = new THOITIET.Controls.CongTacDonVi();
            ...
            bangChiTiet = new TableLayoutPanel();
            panelCamGiac = new Panel();
            panelDoAm = new Panel();
            panelGio = new Panel();
            panelApSuat = new Panel();
            panelTamNhin = new Panel();
            ...
            congTacDonVi.Font = new Font("Segoe UI", 10F);
            congTacDonVi.IsCelsius = true;
            congTacDonVi.Location = new Point(1215, 13);
            congTacDonVi.Name = "congTacDonVi";
            congTacDonVi.Size = new Size(104, 34);
            congTacDonVi.TabIndex = 1;
            // 
            // oTimKiemDiaDiem
            // 
            ...
            oTimKiemDiaDiem.TextChanged += oTimKiemDiaDiem_TextChanged;
            // 
            // CongTacDonVi
            // 
            ...
            // listBoxGoiY
            // 
            listBoxGoiY.Location = new Point(19, 47);
            listBoxGoiY.Name = "listBoxGoiY";
            listBoxGoiY.Size = new Size(300, 120);
            listBoxGoiY.TabIndex = 0;
            listBoxGoiY.Visible = false;
            listBoxGoiY.SelectedIndexChanged += listBoxGoiY_SelectedIndexChanged;
            // 
            // listBoxDiaDiemDaLuu
            // 
            ...
            // tabDieuKhien
            // 
            tabDieuKhien.Controls.Add(tabBieuDo);
            tabDieuKhien.Controls.Add(tabBanDo);
            ...
            // tabBieuDo
            // 
            tabBieuDo.Location = new Point(4, 29);
            tabBieuDo.Name = "tabBieuDo";
            tabBieuDo.Padding = new Padding(8);
            tabBieuDo.Size = new Size(585, 262);
            tabBieuDo.TabIndex = 0;
            tabBieuDo.Text = "Biểu đồ nhiệt độ";
            tabBieuDo.UseVisualStyleBackColor = true;
            // 
            // tabBanDo
            // 
            tabBanDo.Location = new Point(4, 29);
            tabBanDo.Name = "tabBanDo";
            tabBanDo.Padding = new Padding(8);
            tabBanDo.Size = new Size(585, 262);
            tabBanDo.TabIndex = 1;
            tabBanDo.Text = "Bản đồ";
            tabBanDo.UseVisualStyleBackColor = true;
            // 
            // 
            // khuVucDuoi_24Gio
            // 
            ...
            khuVucTrai_HienTai.Controls.Add(bangChiTiet);
            ...
            // bangChiTiet
            // 
            bangChiTiet.BackColor = Color.Transparent;
            bangChiTiet.ColumnCount = 3;
            bangChiTiet.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 33.33F));
            bangChiTiet.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 33.33F));
            bangChiTiet.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 33.33F));
            bangChiTiet.Controls.Add(panelCamGiac, 0, 0);
            bangChiTiet.Controls.Add(panelDoAm, 1, 0);
            bangChiTiet.Controls.Add(panelGio, 2, 0);
            bangChiTiet.Controls.Add(panelApSuat, 0, 1);
            bangChiTiet.Controls.Add(panelTamNhin, 1, 1);
            bangChiTiet.Dock = DockStyle.Bottom;
            bangChiTiet.Location = new Point(0, 221);
            bangChiTiet.Name = "bangChiTiet";
            bangChiTiet.Padding = new Padding(5);
            bangChiTiet.RowCount = 2;
            bangChiTiet.RowStyles.Add(new RowStyle(SizeType.Percent, 50F));
            bangChiTiet.RowStyles.Add(new RowStyle(SizeType.Percent, 50F));
            bangChiTiet.Size = new Size(726, 196);
            bangChiTiet.TabIndex = 3;
            // 
            // panelCamGiac
            // 
            panelCamGiac.BackColor = Color.FromArgb(120, 255, 255, 255);
            panelCamGiac.Dock = DockStyle.Fill;
            panelCamGiac.Location = new Point(8, 8);
            panelCamGiac.Name = "panelCamGiac";
            panelCamGiac.Padding = new Padding(10);
            panelCamGiac.Size = new Size(232, 87);
            panelCamGiac.TabIndex = 0;
            // 
            // panelDoAm
            // 
            panelDoAm.BackColor = Color.FromArgb(120, 255, 255, 255);
            panelDoAm.Dock = DockStyle.Fill;
            panelDoAm.Location = new Point(246, 8);
            panelDoAm.Name = "panelDoAm";
            panelDoAm.Padding = new Padding(10);
            panelDoAm.Size = new Size(232, 87);
            panelDoAm.TabIndex = 1;
            // 
            // panelGio
            // 
            panelGio.BackColor = Color.FromArgb(120, 255, 255, 255);
            panelGio.Dock = DockStyle.Fill;
            panelGio.Location = new Point(484, 8);
            panelGio.Name = "panelGio";
            panelGio.Padding = new Padding(10);
            panelGio.Size = new Size(234, 87);
            panelGio.TabIndex = 2;
            // 
            // panelApSuat
            // 
            panelApSuat.BackColor = Color.FromArgb(120, 255, 255, 255);
            panelApSuat.Dock = DockStyle.Fill;
            panelApSuat.Location = new Point(8, 101);
            panelApSuat.Name = "panelApSuat";
            panelApSuat.Padding = new Padding(10);
            panelApSuat.Size = new Size(232, 87);
            panelApSuat.TabIndex = 3;
            // 
            // panelTamNhin
            // 
            panelTamNhin.BackColor = Color.FromArgb(120, 255, 255, 255);
            panelTamNhin.Dock = DockStyle.Fill;
            panelTamNhin.Location = new Point(246, 101);
            panelTamNhin.Name = "panelTamNhin";
            panelTamNhin.Padding = new Padding(10);
            panelTamNhin.Size = new Size(232, 87);
            panelTamNhin.TabIndex = 4;
            // 
            // anhNenDong
            // 
            ...
            bangChiTiet.ResumeLayout(false);
        ...
        private THOITIET.Controls.CongTacDonVi congTacDonVi;
        ...
        private TableLayoutPanel bangChiTiet;
        private Panel panelCamGiac;
        private Panel panelDoAm;
        private Panel panelGio;
        private Panel panelApSuat;
        private Panel panelTamNhin;
    }
}