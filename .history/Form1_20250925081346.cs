    ...
    public partial class Form1 : Form
    {
        ...
        private async Task CapNhatThoiTiet()
        {
            ...
            try
            {
                ...
                if (weatherData.Current != null)
                {
                    ...
                    nhanTrangThai.Text = GetVietnameseWeatherDescription(current.Weather?[0]?.Description ?? "Không xác định");
        ...
        private Panel TaoCardGio(HourlyWeather hour, string kyHieu)
        {
            try
            {
                ...
                panel.Click += (s, e) =>
                {
                    ...
                    nhanTrangThai.Text = GetVietnameseWeatherDescription(hour.Weather?[0]?.Description ?? "N/A");
        ...
        private string GetVietnameseWeatherDescription(string description)
        {
            ...
            var vietnameseMap = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                { "heavy rain", "Mưa cường độ nặng" },
                { "very heavy rain", "Mưa cường độ rất nặng" },
