...
namespace THOITIET
{
    ...
    public class WeatherDisplayService
    {
        ...
        /// </summary>
        public void DisplayWeatherInfo(string locationName, OneCallResponse weather, bool isCelsius, 
            ...
            PictureBox picWeatherIcon, Panel detailPanel)
        {
            try
            {
                ...
                if (weather?.Current != null)
                {
                    UpdateDetailPanel(weather.Current, kyHieuNhietDo, detailPanel);
                }
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        public void UpdateDetailPanelFromApi(CurrentWeather current, string kyHieu, Panel detailPanel)
        {
            try
            {
