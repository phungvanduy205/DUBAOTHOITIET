            ...
            try
            {
                ...
                if (suggestionPanel == null)
                {
                    suggestionPanel = new Panel
                    {
                        ...
                        BackColor = Color.FromArgb(120, 255, 255, 255), // Nền trắng mờ
                        Size = new Size(400, 30), // Panel mỏng để chạy chữ
                        Location = new Point(20, 350), // Vị trí dưới các panel thông tin
                ...
                var scrollingLabel = new Label
                {
                    ...
                    Location = new Point(400, 5), // Bắt đầu từ bên phải
                    Size = new Size(800, 20), // Kích thước lớn để chứa text dài
                ...
                scrollTimer.Tick += (sender, e) =>
                {
                    ...
                    {
                        scrollingLabel.Location = new Point(400, 5); // Reset về bên phải
                    }
                    else
                    {
