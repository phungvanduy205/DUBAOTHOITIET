...
namespace THOITIET
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            return GetWeatherIconFromEmoji(iconPath, 180); // Kích thước lớn ngang với emoji cũ
        }
        ...
        {
            return GetWeatherIconFromEmoji(iconPath, 40); // Kích thước nhỏ cho biểu đồ
        }
        ...
        private Panel TaoCardGio(HourlyWeather hour, string kyHieu)
        {
            try
            {
                ...
                try
                {
                    var iconImage = GetWeatherIconFromEmojiSmall(GetWeatherIcon(hour.Weather?[0]?.Icon));
                    if (iconImage != null)
                    {
            ...
            try
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        var iconImage = GetWeatherIconFromEmojiSmall(GetWeatherIcon(iconCode));
                        if (iconImage != null)
                        {
                            picIcon.Image = iconImage;
                        }
