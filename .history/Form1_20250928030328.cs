    ...
    public partial class Form1 : Form
    {
        ...
        private void TaoNutDongForm()
        {
            ...
            var nutPhongToWindy = new Button
            {
                Text = "🗺️",
                Size = new Size(40, 40),
                Location = new Point(this.Width - 100, 10), // Bên cạnh nút đóng
                FlatStyle = FlatStyle.Flat,
            ...
            nutPhongToWindy.FlatAppearance.BorderSize = 0;
            nutPhongToWindy.Click += (s, e) => MoCuaSoWindyPhongTo();
            nutPhongToWindy.MouseEnter += (s, e) => nutPhongToWindy.BackColor = Color.FromArgb(200, 255, 255, 255);
            nutPhongToWindy.MouseLeave += (s, e) => nutPhongToWindy.BackColor = Color.FromArgb(150, 255, 255, 255);
