    ...
    public partial class Form1 : Form
    {
        ...
        private void TaoPanelDuBaoGioMoi(Panel panel, string icon, string gio, string nhietDo, string trangThai)
        {
            try
            {
                ...
                // Label nhiệt độ (trên cùng, giữa) - đổi vị trí với giờ
                var nhietDoLabel = new Label
                {
                    Text = nhietDo,
                ...
                // Label giờ (dưới trạng thái) - đổi vị trí với nhiệt độ
                var gioLabel = new Label
                {
                    ...
                    Size = new Size(panel.Width - 16, 22)
                };

                // Label icon (dưới cùng) - kéo xuống dưới và tăng kích thước
                var iconLabel = new Label
                {
                    Text = icon,
                    Font = new Font("Segoe UI Emoji", 28F), // Tăng kích thước icon
                    ForeColor = Color.White,
                    BackColor = Color.Transparent,
                    TextAlign = ContentAlignment.MiddleCenter,
                    Location = new Point(8, 105),
                    Size = new Size(panel.Width - 16, 50)
                };
