    ...
    public partial class Form1 : Form
    {
        ...
        private void TaoPanelDuBaoGioMoi(Panel panel, string icon, string gio, string nhietDo, string trangThai)
        {
            try
            {
                ...
                // 1. Label giờ (trên cùng) - theo sơ đồ
                ...
                // 2. Label thời tiết (mô tả) - theo sơ đồ
                var trangThaiLabel = new Label
                {
                    Text = trangThai,
                    Font = new Font("Segoe UI", 9F),
                ...
                // 3. Label thông tin (nhiệt độ) - theo sơ đồ
                var nhietDoLabel = new Label
                {
                    Text = nhietDo,
                ...
                // 4. Label icon (dưới cùng) - theo sơ đồ, tăng kích thước
                var iconLabel = new Label
                {
                    Text = icon,
                    Font = new Font("Segoe UI Emoji", 36F), // Tăng kích thước icon lên 36
                    ForeColor = Color.White,
                    BackColor = Color.Transparent,
                    TextAlign = ContentAlignment.MiddleCenter,
                    Location = new Point(8, 110),
                    Size = new Size(panel.Width - 16, 70)
                };
