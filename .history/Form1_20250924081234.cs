    ...
    public partial class Form1 : Form
    {
        ...
        private void Show24hChartForDay(DailyWeather daily)
        {
            try
            {
                ...
                temperatureChart.ChartAreas[0].AxisX.Interval = 1; // hiện mỗi giờ từ 0,1,2...
                temperatureChart.ChartAreas[0].AxisX.LabelStyle.Font = new Font("Segoe UI", 10, FontStyle.Regular);
