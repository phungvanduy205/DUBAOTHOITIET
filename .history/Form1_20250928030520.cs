...
namespace THOITIET
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void TaoNutDongForm()
        {
            ...
            // Tạo nút phóng to bản đồ Windy
            var nutPhongToWindy = new Button
            {
                Text = "🗺️ Phóng to",
                Size = new Size(100, 35),
                Location = new Point(this.Width - 140, 5), // Bên cạnh nút đóng
                FlatStyle = FlatStyle.Flat,
                BackColor = Color.FromArgb(200, 0, 150, 255), // Màu xanh dương rõ ràng
                ForeColor = Color.White,
            ...
            this.Controls.Add(nutPhongToWindy);
