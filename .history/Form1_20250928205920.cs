    ...
    public partial class Form1 : Form
    {
        ...
        private void HienThiThongTin(string name, OneCallResponse weather)
        {
            try
            {
                ...
                // Debug: Hiển thị mô tả tiếng Anh để kiểm tra
                Console.WriteLine($"Weather Description (EN): {currentDescEn}");
                Console.WriteLine($"Suggestions Count: {currentSuggestions.Count}");
                
                var suggestionText = currentSuggestions.Count > 0 
                    ? $"\n💡 {string.Join("\n💡 ", currentSuggestions)}" 
                    : $"\n💡 Không có gợi ý cho: {currentDescEn}";
        ...
        private List<string> GetWeatherSuggestions(string weatherDesc)
        {
            ...
            // Debug
            Console.WriteLine($"GetWeatherSuggestions - Input: '{weatherDesc}', Lower: '{desc}'");
            ...
            else if (desc.Contains("heavy rain") || desc.Contains("heavy intensity rain"))
            {
                ...
                suggestions.Add("🏠 Ở trong nhà - Thích hợp đọc sách, xem phim");
