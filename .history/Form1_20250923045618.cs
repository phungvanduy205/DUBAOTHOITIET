    ...
    public partial class Form1 : Form
    {
        ...
        private void LoadSavedLocations()
        {
            try
            {
                ...
                currentLocationIndex = savedLocationNames.IndexOf(defaultLocation);
        ...
        private void SaveLocationList()
        {
            try
            {
                var data = new
                {
                    ...
                    defaultLocation = savedLocationNames.Count > currentLocationIndex ? savedLocationNames[currentLocationIndex] : defaultLocation
                };
