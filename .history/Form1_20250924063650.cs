    ...
    public partial class Form1 : Form
    {
        ...
        private void SetBackground(string weatherMain = "Clear", int weatherId = 800)
        {
            try
            {
                ...
                else if (weatherId >= 300 && weatherId <= 321)
                {
                    ...
                    System.Diagnostics.Debug.WriteLine($"Chọn nền: nen_mua_rao.jpgjpg (drizzle - {weatherId})");
                }
        ...
        private void Show24hChartForDay(DailyWeather daily)
        {
            try
            {
                ...
                temperatureChart.ChartAreas[0].AxisX.LabelStyle.Font = new Font("Segoe UI", 10F, FontStyle.Regular);
                temperatureChart.ChartAreas[0].AxisY.LabelStyle.Font = new Font("Segoe UI", 10F, FontStyle.Regular);
