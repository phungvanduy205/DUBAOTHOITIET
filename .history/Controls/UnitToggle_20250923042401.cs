    ...
    public class UnitToggle : UserControl
    {
        ...
        private void ApplyRoundedCorners()
        {
            try
            {
                ...
                btnC.Region = System.Drawing.Region.FromHrgn(CreateRoundRectRgn(0, 0, btnC.Width, btnC.Height, 15, 15));
                btnF.Region = System.Drawing.Region.FromHrgn(CreateRoundRectRgn(0, 0, btnF.Width, btnF.Height, 15, 15));
            }
            catch
            {
