    ...
    public partial class Form1 : Form
    {
        ...
        private Panel TaoCardNgay(DailyWeather daily, string kyHieu)
        {
            try
            {
                var panel = new Panel
                {
                    Size = new Size(120, 180), // Nhỏ hơn để phù hợp với layout ngang
                    BackColor = Color.FromArgb(80, 128, 128, 128),
                    BorderStyle = BorderStyle.FixedSingle,
                ...
                var lblTemp = new Label
                {
                    ...
                    Dock = DockStyle.Fill,
                    TextAlign = ContentAlignment.MiddleCenter,
                    Font = new Font("Segoe UI", 16F, FontStyle.Bold), // Font nhỏ hơn cho card nhỏ
                    ForeColor = Color.White,
                    BackColor = Color.Transparent
                };
                ...
                var lblDesc = new Label
                {
                    ...
                    Dock = DockStyle.Fill,
                    TextAlign = ContentAlignment.TopCenter,
                    Font = new Font("Segoe UI", 10F), // Font nhỏ hơn
                    ForeColor = Color.White,
                    BackColor = Color.Transparent,
                    AutoSize = true,
                    MaximumSize = new Size(110, 0), // Nhỏ hơn cho card nhỏ
                    UseCompatibleTextRendering = true,
                    AutoEllipsis = false
                };
