namespace THOITIET
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            BangTheoGio.BackColor = Color.FromArgb(50, Color.Black);
            BangTheoGio.Dock = DockStyle.Fill;
            BangTheoGio.FlowDirection = FlowDirection.LeftToRight;
            ...
            BangNhieuNgay.BackColor = Color.FromArgb(50, Color.Black);
            BangNhieuNgay.Dock = DockStyle.Fill;
            BangNhieuNgay.FlowDirection = FlowDirection.LeftToRight;
            ...
            // bgGif
            // 
            bgGif.Dock = DockStyle.Fill;
            bgGif.Location = new Point(0, 0);
            bgGif.Name = "bgGif";
            bgGif.Size = new Size(1200, 700);
            bgGif.SizeMode = PictureBoxSizeMode.StretchImage;
            bgGif.TabIndex = 0;
            bgGif.TabStop = false;
            // 
            // Form1
            ...
            BackgroundImage = null; // Không dùng BackgroundImage của Form
            ...
            ((System.ComponentModel.ISupportInitialize)bgGif).EndInit();
