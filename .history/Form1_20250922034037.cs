    ...
    public partial class Form1 : Form
    {
            ...
            try
            {
                ...
                switch (weatherMain.ToLower())
                {
                    ...
                    case "drizzle":
                        ...
                        {
                            backgroundImage = Image.FromFile(Path.Combine(resourcesPath, "nen_ban_dem.gif"));
                            System.Diagnostics.Debug.WriteLine("Chọn nền: nen_ban_dem.gif (mưa đêm)");
                        }
                        else
                        {
                    ...
                    case "thunderstorm":
                        ...
                        {
                            backgroundImage = Image.FromFile(Path.Combine(resourcesPath, "nen_ban_dem.gif"));
                            System.Diagnostics.Debug.WriteLine("Chọn nền: nen_ban_dem.gif (bão đêm)");
                        }
                        else
                        {
                    ...
                    case "haze":
                        ...
                        {
                            backgroundImage = Image.FromFile(Path.Combine(resourcesPath, "nen_ban_dem.gif"));
                            System.Diagnostics.Debug.WriteLine("Chọn nền: nen_ban_dem.gif (sương mù đêm)");
                        }
                        else
                        {
                    ...
                    case "clouds":
                        ...
                        {
                            backgroundImage = Image.FromFile(Path.Combine(resourcesPath, "nen_ban_dem.gif"));
                            System.Diagnostics.Debug.WriteLine("Chọn nền: nen_ban_dem.gif (mây đêm)");
                        }
                        else
                        {
        ...
        private void CapNhatThoiGian()
        {
            try
            {
                ...
                {
                    // Fallback background cho boCucChinh
                    if (boCucChinh != null)
                    {
                        boCucChinh.BackgroundImage = TaoBackgroundTest("troi_quang");
                        boCucChinh.BackgroundImageLayout = ImageLayout.Stretch;
                    }
                }
            }
