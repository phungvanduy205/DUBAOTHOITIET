    ...
    public partial class Form1 : Form
    {
        ...
        private void Show24hChartForDay(DailyWeather daily)
        {
            try
            {
                ...
                temperatureChart.ChartAreas[0].AxisY.TitleFont = new Font("Segoe UI", 14, FontStyle.Bold);
                temperatureChart.ChartAreas[0].AxisY.TitleForeColor = Color.White;
                temperatureChart.ChartAreas[0].AxisY.LabelStyle.Font = new Font("Segoe UI", 12, FontStyle.Bold);
