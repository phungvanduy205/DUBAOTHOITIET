...
namespace THOITIET
{
    ...
    {
        private readonly string API_KEY = Environment.GetEnvironmentVariable("OPENWEATHER_API_KEY") ?? throw new InvalidOperationException("Vui lòng cấu hình OPENWEATHER_API_KEY");
        private readonly HttpClient http = new HttpClient();
        private readonly string GOOGLE_API_KEY = Environment.GetEnvironmentVariable("GOOGLE_GEOCODING_API_KEY") ?? "";
        private readonly string GEOAPIFY_API_KEY = Environment.GetEnvironmentVariable("GEOAPIFY_API_KEY") ?? "";
