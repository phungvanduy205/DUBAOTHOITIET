namespace THOITIET
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            BangTheoGio = new TableLayoutPanel();
            ...
            BangNhieuNgay = new TableLayoutPanel();
            ...
            CongTacDonVi.FlatAppearance.BorderSize = 0;
            CongTacDonVi.FlatStyle = FlatStyle.Flat;
            ...
            CongTacDonVi.Size = new Size(93, 30);
            CongTacDonVi.TabIndex = 2;
            CongTacDonVi.Text = "°C";
            CongTacDonVi.UseVisualStyleBackColor = false;
            ...
            BangTheoGio.BackColor = Color.Transparent;
            BangTheoGio.ColumnCount = 24;
            BangTheoGio.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 4.166667F));
            BangTheoGio.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 4.166667F));
            BangTheoGio.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 4.166667F));
            BangTheoGio.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 4.166667F));
            BangTheoGio.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 4.166667F));
            ...
            BangTheoGio.RowCount = 1;
            BangTheoGio.RowStyles.Add(new RowStyle(SizeType.Percent, 100F));
            ...
            anhIconThoiTiet.Location = new Point(531, 51);
            anhIconThoiTiet.Name = "anhIconThoiTiet";
            anhIconThoiTiet.Size = new Size(175, 129);
            ...
            nhanTenDiaDiem.Location = new Point(23, 1);
            ...
            nhanThoiGian.Location = new Point(32, 40);
            ...
            nhanNhietDoHienTai.Location = new Point(11, 68);
            ...
            nhanTrangThai.Location = new Point(17, 146);
            ...
            BangNhieuNgay.BackColor = Color.Transparent;
            BangNhieuNgay.ColumnCount = 5;
            BangNhieuNgay.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 20F));
            BangNhieuNgay.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 20F));
            BangNhieuNgay.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 20F));
            BangNhieuNgay.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 20F));
            BangNhieuNgay.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 20F));
            ...
            BangNhieuNgay.RowCount = 1;
            BangNhieuNgay.RowStyles.Add(new RowStyle(SizeType.Percent, 100F));
        ...
        private System.Windows.Forms.Button CongTacDonVi;
