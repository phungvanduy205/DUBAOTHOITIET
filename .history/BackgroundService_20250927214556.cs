...
namespace THOITIET
{
    public class BackgroundService
    {
        ...
        public void InitializeBackgroundPictureBox(Panel mainPanel)
        {
            ...
            {
                if (mainPanel == null) return;
                // Initialize background picture box if needed
            }
            catch (Exception ex)
            {
                System.Diagnostics.Debug.WriteLine($"InitializeBackgroundPictureBox error: {ex.Message}");
            }
        }
        ...
        public void SetDefaultBackgroundOnStartup(Panel mainPanel)
        {
            ...
            {
                if (mainPanel == null) return;
                ForceSetBackgroundInLoad(mainPanel);
            }
            catch (Exception ex)
            {
