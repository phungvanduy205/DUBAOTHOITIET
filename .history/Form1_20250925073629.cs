            ...
            try
            {
                ...
                if (suggestionPanel == null)
                {
                    suggestionPanel = new Panel
                    {
                        ...
                        BackColor = Color.FromArgb(150, 255, 255, 255), // Nền trắng mờ hơn
                        Size = new Size(350, 100),
                        Location = new Point(50, 50), // Vị trí góc trên phải
                        BorderStyle = BorderStyle.None
                    };
                    ApplyRoundedCorners(suggestionPanel, 15);
                    Controls.Add(suggestionPanel);
                    suggestionPanel.BringToFront(); // Đưa lên trên cùng
                }
