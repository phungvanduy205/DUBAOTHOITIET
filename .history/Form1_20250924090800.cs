...
namespace THOITIET
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void SetDefaultLocation()
        {
            try
            {
                ...
                if (selectedIndex >= 0 && selectedIndex < favoriteLocations.Count)
                {
                    ...
                    // Đảm bảo địa điểm này có trong savedLocationNames
                    var locationName = favoriteLocations[selectedIndex].Name;
                    if (!savedLocationNames.Contains(locationName))
                    {
        ...
        /// <summary>
        /// Event handler cho button chọn mặc định
        /// </summary>
