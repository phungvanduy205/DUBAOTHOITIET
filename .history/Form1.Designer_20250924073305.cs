namespace THOITIET
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            tabChart.Padding = new Padding(1);
            tabChart.TabIndex = 0;
            ...
            detailGridPanel.ColumnCount = 5;
            detailGridPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 200F));
            detailGridPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 200F));
            detailGridPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 200F));
            detailGridPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 200F));
            detailGridPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 200F));
            ...
            detailGridPanel.Controls.Add(pressurePanel, 3, 0);
            detailGridPanel.Controls.Add(visibilityPanel, 4, 0);
            ...
            detailGridPanel.RowCount = 1;
            detailGridPanel.RowStyles.Add(new RowStyle(SizeType.Percent, 100F));
            detailGridPanel.Size = new Size(726, 100);
            detailGridPanel.TabIndex = 3;
            detailGridPanel.AutoScroll = true;
            // 
            // feelsLikePanel
            // 
