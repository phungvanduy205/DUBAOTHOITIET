        ...
        private void TaoPanelDuBaoGioMoi(Panel panel, string icon, string gio, string nhietDo, string trangThai)
        {
            try
            {
                ...
                var gioLabel = new Label
                {
                    ...
                    TextAlign = ContentAlignment.MiddleCenter,
                    Location = new Point(8, 8),
                    Size = new Size(panel.Width - 16, 25)
                };
                ...
                {
                    Text = nhietDo,
                    Font = new Font("Segoe UI", 16F, FontStyle.Bold), // Tăng kích thước font lên 16
                    ForeColor = Color.White,
                    BackColor = Color.Transparent,
                    TextAlign = ContentAlignment.MiddleCenter,
                    Location = new Point(8, 40),
                    Size = new Size(panel.Width - 16, 30)
                };

                // 3. Label thời tiết (mô tả, vị trí thứ 3) - tăng kích thước để không bị đè
                var trangThaiLabel = new Label
                {
                    Text = trangThai,
                    Font = new Font("Segoe UI", 9F),
                    ...
                    Size = new Size(panel.Width - 16, 40) // Tăng height để không bị đè
                };
                ...
                var iconLabel = new Label
                {
                    ...
                    Size = new Size(panel.Width - 16, 60)
                };
