    ...
    public partial class Form1 : Form
    {
        ...
        private void Show24hChartForDay(DailyWeather daily)
        {
            try
            {
                ...
                temperatureChart.ChartAreas[0].AxisX.LabelStyle.Font = new Font("Segoe UI", 10);
                ...
                temperatureChart.ChartAreas[0].AxisY.LabelStyle.Font = new Font("Segoe UI", 10);
        ...
        private void CreateRainProbabilityChart(GroupBox parent)
        {
            try
            {
                ...
                var rainProbSeries = new Series("Tỉ lệ mưa")
                {
                    ...
                    MarkerSize = 4,
                    MarkerColor = Color.White,
                    MarkerBorderColor = Color.FromArgb(255, 74, 144, 226),
                    MarkerBorderWidth = 2
                };
        ...
        private void InitializeTemperatureChart()
        {
            try
            {
                ...
                {
                    Location = new Point(10, 10),
                    Size = new Size(tabChart.Width - 30, 300),
                    Font = new Font("Segoe UI", 12F, FontStyle.Bold),
                    ForeColor = Color.White,
                ...
                // 2. Biểu đồ tỉ lệ mưa
                var rainProbGroup = new GroupBox
                {
                    Location = new Point(10, 320),
                    Size = new Size(tabChart.Width - 30, 200),
                    Font = new Font("Segoe UI", 12F, FontStyle.Bold),
                    ForeColor = Color.White,
                ...
                // Tạo biểu đồ tỉ lệ mưa
                CreateRainProbabilityChart(rainProbGroup);
                
                mainPanel.Controls.Add(tempChartGroup);
                mainPanel.Controls.Add(rainProbGroup);
