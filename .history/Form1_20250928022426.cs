...
namespace THOITIET
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void LoadWindyMap(double lat, double lon)
        {
            ...
            System.Diagnostics.Debug.WriteLine($"[API DEBUG] Gọi Windy API: {embedUrl}");
            System.Diagnostics.Debug.WriteLine($"[API DEBUG] Windy API Key: {KHOABAN_DOGIO.Substring(0, Math.Min(8, KHOABAN_DOGIO.Length))}...");
