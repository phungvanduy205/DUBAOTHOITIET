    ...
    public partial class Form1 : Form
    {
        ...
        private Panel TaoCardNgay(DailyWeather daily, string kyHieu)
        {
            try
            {
                ...
                picIcon.Click += (s, e) => panel.PerformClick();
                lblDay.Click += (s, e) => panel.PerformClick();
                lblDesc.Click += (s, e) => panel.PerformClick();
                lblTemp.Click += (s, e) => panel.PerformClick();
                lblRainWind.Click += (s, e) => panel.PerformClick();
                lblDebug.Click += (s, e) => panel.PerformClick();
