    ...
    public partial class Form1 : Form
    {
        ...
        private void HienThiGoiYThoiTiet(CurrentWeather current)
        {
            try
            {
                ...
                {
                    Text = scrollingText,
                    Font = new Font("Segoe UI", 10F, FontStyle.Bold), // Font vừa phải
                    ForeColor = Color.FromArgb(20, 20, 20), // Màu đậm hơn
                    Location = new Point(suggestionPanel.Width, 8), // Bắt đầu từ bên phải panel
                    Size = new Size(800, 20), // Kích thước phù hợp
