namespace THOITIET
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            tabMap = new TabPage();
            tabWeatherHistory = new TabPage();
            historyMainPanel = new Panel();
            historyTopPanel = new Panel();
            historyTimeFilter = new ComboBox();
            btnSaveCurrentWeather = new Button();
            btnRefreshHistory = new Button();
            btnClearAllHistory = new Button();
            historyContentPanel = new Panel();
            historyDaysPanel = new FlowLayoutPanel();
            historyChartPanel = new Panel();
            historyChartType = new ComboBox();
            ...
            tabWeatherHistory.SuspendLayout();
            historyMainPanel.SuspendLayout();
            historyTopPanel.SuspendLayout();
            historyContentPanel.SuspendLayout();
            historyChartPanel.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)historyChart).BeginInit();
            ...
            tabDieuKhien.Controls.Add(tabWeatherHistory);
            ...
            // tabWeatherHistory
            // 
            tabWeatherHistory.Controls.Add(historyMainPanel);
            tabWeatherHistory.Location = new Point(4, 29);
            tabWeatherHistory.Name = "tabWeatherHistory";
            tabWeatherHistory.Padding = new Padding(8);
            tabWeatherHistory.Size = new Size(585, 287);
            tabWeatherHistory.TabIndex = 2;
            tabWeatherHistory.Text = "Lịch sử thời tiết";
            tabWeatherHistory.UseVisualStyleBackColor = true;
            // 
            // historyMainPanel
            // 
            historyMainPanel.Controls.Add(historyContentPanel);
            historyMainPanel.Controls.Add(historyTopPanel);
            historyMainPanel.Dock = DockStyle.Fill;
            historyMainPanel.Location = new Point(8, 8);
            historyMainPanel.Name = "historyMainPanel";
            historyMainPanel.Size = new Size(569, 271);
            historyMainPanel.TabIndex = 0;
            // 
            // historyTopPanel
            // 
            historyTopPanel.Controls.Add(historyTimeFilter);
            historyTopPanel.Controls.Add(btnSaveCurrentWeather);
            historyTopPanel.Controls.Add(btnRefreshHistory);
            historyTopPanel.Controls.Add(btnClearAllHistory);
            historyTopPanel.Dock = DockStyle.Top;
            historyTopPanel.Location = new Point(0, 0);
            historyTopPanel.Name = "historyTopPanel";
            historyTopPanel.Size = new Size(569, 40);
            historyTopPanel.TabIndex = 0;
            // 
            // historyTimeFilter
            // 
            historyTimeFilter.DropDownStyle = ComboBoxStyle.DropDownList;
            historyTimeFilter.FormattingEnabled = true;
            historyTimeFilter.Items.AddRange(new object[] { "1 tuần", "1 tháng", "3 tháng", "6 tháng", "1 năm", "Tất cả" });
            historyTimeFilter.Location = new Point(8, 8);
            historyTimeFilter.Name = "historyTimeFilter";
            historyTimeFilter.Size = new Size(100, 28);
            historyTimeFilter.TabIndex = 0;
            historyTimeFilter.SelectedIndex = 1;
            historyTimeFilter.SelectedIndexChanged += historyTimeFilter_SelectedIndexChanged;
            // 
            // btnSaveCurrentWeather
            // 
            btnSaveCurrentWeather.Location = new Point(120, 8);
            btnSaveCurrentWeather.Name = "btnSaveCurrentWeather";
            btnSaveCurrentWeather.Size = new Size(100, 24);
            btnSaveCurrentWeather.TabIndex = 1;
            btnSaveCurrentWeather.Text = "Lưu hiện tại";
            btnSaveCurrentWeather.UseVisualStyleBackColor = true;
            btnSaveCurrentWeather.Click += btnSaveCurrentWeather_Click;
            // 
            // btnRefreshHistory
            // 
            btnRefreshHistory.Location = new Point(230, 8);
            btnRefreshHistory.Name = "btnRefreshHistory";
            btnRefreshHistory.Size = new Size(80, 24);
            ...
            // btnClearAllHistory
            // 
            btnClearAllHistory.Location = new Point(320, 8);
            btnClearAllHistory.Name = "btnClearAllHistory";
            btnClearAllHistory.Size = new Size(80, 24);
            btnClearAllHistory.TabIndex = 3;
            btnClearAllHistory.Text = "Xóa tất cả";
            btnClearAllHistory.UseVisualStyleBackColor = true;
            btnClearAllHistory.Click += btnClearAllHistory_Click;
            // 
            // historyContentPanel
            // 
            historyContentPanel.Controls.Add(historyChartPanel);
            historyContentPanel.Controls.Add(historyDaysPanel);
            historyContentPanel.Dock = DockStyle.Fill;
            historyContentPanel.Location = new Point(0, 40);
            historyContentPanel.Name = "historyContentPanel";
            historyContentPanel.Size = new Size(569, 231);
            historyContentPanel.TabIndex = 1;
            // 
            // historyDaysPanel
            // 
            historyDaysPanel.AutoScroll = true;
            historyDaysPanel.BackColor = Color.FromArgb(50, 0, 0, 0);
            historyDaysPanel.Dock = DockStyle.Fill;
            historyDaysPanel.FlowDirection = FlowDirection.TopDown;
            historyDaysPanel.Location = new Point(0, 0);
            historyDaysPanel.Name = "historyDaysPanel";
            historyDaysPanel.Padding = new Padding(4);
            historyDaysPanel.Size = new Size(569, 231);
            historyDaysPanel.TabIndex = 0;
            historyDaysPanel.WrapContents = false;
            // 
            // historyChartPanel
            // 
            historyChartPanel.Controls.Add(historyChart);
            historyChartPanel.Controls.Add(historyChartType);
            historyChartPanel.Dock = DockStyle.Fill;
            historyChartPanel.Location = new Point(0, 0);
            historyChartPanel.Name = "historyChartPanel";
            historyChartPanel.Size = new Size(569, 231);
            historyChartPanel.TabIndex = 1;
            historyChartPanel.Visible = false;
            // 
            // historyChartType
            // 
            historyChartType.Anchor = AnchorStyles.Top | AnchorStyles.Right;
            historyChartType.DropDownStyle = ComboBoxStyle.DropDownList;
            historyChartType.FormattingEnabled = true;
            historyChartType.Items.AddRange(new object[] { "Nhiệt độ theo tháng", "Trung bình nhiệt độ", "Lượng mưa theo tháng" });
            historyChartType.Location = new Point(400, 8);
            historyChartType.Name = "historyChartType";
            historyChartType.Size = new Size(150, 28);
            historyChartType.TabIndex = 1;
            historyChartType.SelectedIndex = 0;
            historyChartType.SelectedIndexChanged += historyChartType_SelectedIndexChanged;
            // 
            // historyChart
            // 
            historyChart.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            historyChart.Location = new Point(8, 40);
            historyChart.Name = "historyChart";
            historyChart.Size = new Size(553, 183);
            historyChart.TabIndex = 0;
            // 
            // weatherHistoryDataGrid
            // 
            weatherHistoryDataGrid.AllowUserToAddRows = false;
            weatherHistoryDataGrid.AllowUserToDeleteRows = false;
            weatherHistoryDataGrid.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            weatherHistoryDataGrid.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            weatherHistoryDataGrid.BackgroundColor = SystemColors.ButtonHighlight;
            weatherHistoryDataGrid.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            weatherHistoryDataGrid.GridColor = SystemColors.ControlLightLight;
            weatherHistoryDataGrid.Location = new Point(8, 8);
            weatherHistoryDataGrid.MultiSelect = false;
            weatherHistoryDataGrid.Name = "weatherHistoryDataGrid";
            weatherHistoryDataGrid.ReadOnly = true;
            weatherHistoryDataGrid.RowHeadersVisible = false;
            weatherHistoryDataGrid.RowHeadersWidth = 51;
            weatherHistoryDataGrid.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            weatherHistoryDataGrid.Size = new Size(569, 200);
            weatherHistoryDataGrid.TabIndex = 0;
            // 
            // weatherHistoryPanel
            // 
            weatherHistoryPanel.Anchor = AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            weatherHistoryPanel.Controls.Add(btnSaveCurrentWeather);
            weatherHistoryPanel.Controls.Add(btnDeleteSelected);
            weatherHistoryPanel.Controls.Add(btnClearAllHistory);
            weatherHistoryPanel.Controls.Add(btnRefreshHistory);
            weatherHistoryPanel.Location = new Point(8, 214);
            weatherHistoryPanel.Name = "weatherHistoryPanel";
            weatherHistoryPanel.Size = new Size(569, 65);
            weatherHistoryPanel.TabIndex = 1;
            // 
            // btnSaveCurrentWeather
            // 
            btnSaveCurrentWeather.Location = new Point(8, 8);
            btnSaveCurrentWeather.Name = "btnSaveCurrentWeather";
            btnSaveCurrentWeather.Size = new Size(120, 30);
            btnSaveCurrentWeather.TabIndex = 0;
            btnSaveCurrentWeather.Text = "Lưu thời tiết hiện tại";
            btnSaveCurrentWeather.UseVisualStyleBackColor = true;
            btnSaveCurrentWeather.Click += btnSaveCurrentWeather_Click;
            // 
            // btnDeleteSelected
            // 
            btnDeleteSelected.Location = new Point(134, 8);
            btnDeleteSelected.Name = "btnDeleteSelected";
            btnDeleteSelected.Size = new Size(120, 30);
            ...
            // btnClearAllHistory
            // 
            btnClearAllHistory.Location = new Point(260, 8);
            btnClearAllHistory.Name = "btnClearAllHistory";
            btnClearAllHistory.Size = new Size(120, 30);
            btnClearAllHistory.TabIndex = 2;
            btnClearAllHistory.Text = "Xóa tất cả";
            btnClearAllHistory.UseVisualStyleBackColor = true;
            btnClearAllHistory.Click += btnClearAllHistory_Click;
            // 
            // btnRefreshHistory
            // 
            btnRefreshHistory.Location = new Point(386, 8);
            btnRefreshHistory.Name = "btnRefreshHistory";
            btnRefreshHistory.Size = new Size(120, 30);
            ...
            tabWeatherHistory.ResumeLayout(false);
            historyMainPanel.ResumeLayout(false);
            historyTopPanel.ResumeLayout(false);
            historyContentPanel.ResumeLayout(false);
            historyChartPanel.ResumeLayout(false);
            ((System.ComponentModel.ISupportInitialize)historyChart).EndInit();
        ...
        private TabPage tabWeatherHistory;
        private Panel historyMainPanel;
        private Panel historyTopPanel;
        private ComboBox historyTimeFilter;
        private Button btnSaveCurrentWeather;
        private Button btnRefreshHistory;
        private Button btnClearAllHistory;
        private Panel historyContentPanel;
        private FlowLayoutPanel historyDaysPanel;
        private Panel historyChartPanel;
        private ComboBox historyChartType;
