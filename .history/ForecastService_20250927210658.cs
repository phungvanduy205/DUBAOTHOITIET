    ...
    public class ForecastService
    {
        ...
        private Panel CreateHourCard(DuBaoTheoGioItem hour, string kyHieu, int index)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(hour.IconCode))
                {
                    var iconImage = GetWeatherIconFromEmoji(GetWeatherIcon(hour.IconCode));
                    if (iconImage != null)
                    {
        ...
        private Panel CreateDayCard(DuBaoNgayItem daily, string kyHieu, int index)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(daily.IconCode))
                {
                    var iconImage = GetWeatherIconFromEmoji(GetWeatherIcon(daily.IconCode));
                    if (iconImage != null)
                    {
                        iconPictureBox.Image = iconImage;
                    }
        ...
        private void OnDayCardClick(DuBaoNgayItem daily, string kyHieu, int dayIndex)
        {
            try
            {
                ...
                System.Diagnostics.Debug.WriteLine($"Clicked day: {daily.ThoiGian:dddd}");
