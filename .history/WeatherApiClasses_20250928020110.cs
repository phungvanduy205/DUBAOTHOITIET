    ...
    public static class CauHinhApi
    {
        ...
        private static string LayKhoaApi(string tenKhoa)
        {
            ...
            try
            {
                ...
                // Nếu không tìm thấy file config, hiển thị hướng dẫn
                var message = $"Không tìm thấy file api_config.txt.\n\n" +
                             "Vui lòng tạo file api_config.txt với nội dung:\n" +
                             "OPENWEATHER_API_KEY=your_api_key_here\n" +
                             "GEOCODING_API_KEY=your_geocoding_key_here\n" +
                             "GEOAPIFY_API_KEY=your_geoapify_key_here\n\n" +
                             "Hoặc cấu hình environment variables:\n" +
                             "OPENWEATHER_API_KEY, GEOCODING_API_KEY, GEOAPIFY_API_KEY";
