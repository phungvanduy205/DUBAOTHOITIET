...
namespace THOITIET
{
    ...
    public partial class Form1 : Form
    {
        ...
        /// <summary>
        /// Tải dữ liệu lịch sử thời tiết vào DataGridView
        /// </summary>
        private async Task LoadWeatherHistory()
        {
            try
            {
                ...
                weatherHistoryDataGrid.DataSource = dataTable;
                
                // Định dạng cột
                if (weatherHistoryDataGrid.Columns.Count > 0)
                {
                    weatherHistoryDataGrid.Columns["Id"].Visible = false; // Ẩn cột ID
                    weatherHistoryDataGrid.Columns["Location"].HeaderText = "Địa điểm";
                    weatherHistoryDataGrid.Columns["Temperature"].HeaderText = "Nhiệt độ";
                    weatherHistoryDataGrid.Columns["FeelsLike"].HeaderText = "Cảm giác";
                    weatherHistoryDataGrid.Columns["Humidity"].HeaderText = "Độ ẩm (%)";
                    weatherHistoryDataGrid.Columns["Pressure"].HeaderText = "Áp suất (hPa)";
                    weatherHistoryDataGrid.Columns["WindSpeed"].HeaderText = "Tốc độ gió";
                    weatherHistoryDataGrid.Columns["WindDirection"].HeaderText = "Hướng gió";
                    weatherHistoryDataGrid.Columns["Visibility"].HeaderText = "Tầm nhìn";
                    weatherHistoryDataGrid.Columns["WeatherDescription"].HeaderText = "Mô tả";
                    weatherHistoryDataGrid.Columns["WeatherIcon"].HeaderText = "Icon";
                    weatherHistoryDataGrid.Columns["Unit"].HeaderText = "Đơn vị";
                    weatherHistoryDataGrid.Columns["RecordedAt"].HeaderText = "Thời gian";
                }
            }
            catch (Exception ex)
            {
