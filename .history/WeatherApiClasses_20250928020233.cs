...
namespace THOITIET
{
    public static class CauHinhApi
    {
        ...
        public static string WINDY_API_KEY => LayKhoaApi("WINDY_API_KEY") ?? "NI44O5nRjXST4TKiDk0x7hzaWnpHHiCP"; // Fallback key
        ...
        private static string LayKhoaApi(string tenKhoa)
        {
            ...
            try
            {
                // Tìm file config ở nhiều vị trí
                ...
                foreach (var configFile in possiblePaths)
                {
                ...
                // Nếu không tìm thấy cấu hình, hiển thị hướng dẫn ưu tiên Environment Variables
