...
namespace THOITIET
{
    ...
    public class ChartService
    {
        ...
        /// </summary>
        public void ShowTemperatureChart24h(HourlyWeather[] hourlyList, Chart chartControl)
        {
            try
            {
                if (hourlyList == null || hourlyList.Length == 0 || chartControl == null)
                    return;
                ...
                for (int i = 0; i < hoursToShow.Length; i++)
                {
                    ...
                    var time = DateTimeOffset.FromUnixTimeSeconds(hour.Dt).ToString("HH:mm");
        ...
        /// </summary>
        public void ShowTemperatureChart5Days(DailyWeather[] dailyList, Chart chartControl)
        {
            try
            {
