    ...
    public partial class Form1 : Form
    {
        ...
        private void LuuDiaDiem(string name, double lat, double lon)
        {
            try
            {
                ...
                // Sử dụng LocationService để lưu địa điểm
                locationService.SaveLocation(name, lat, lon);
        ...
        private void LuuDiaDiemSilent(string locationName, double lat, double lon)
        {
            try
            {
                ...
                // Sử dụng LocationService để lưu địa điểm tự động
                locationService.SaveLocationSilent(cleanedName, lat, lon);
