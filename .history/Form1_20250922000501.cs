    ...
    public partial class Form1 : Form
    {
            ...
            try
            {
                ...
                foreach (var item in data24h)
                {
                    var panelDuBao = new Panel
                    {
                        ...
                        Height = 300, // Tăng chiều cao lên 300 để có đủ không gian cho tất cả
        ...
        private void TaoPanelDuBaoGioMoi(Panel panel, string icon, string gio, string nhietDo, string trangThai)
        {
            try
            {
                ...
                // 1. Label giờ (trên cùng) - vị trí 1 - font nhỏ hơn nhiệt độ
                ...
                // 2. Label nhiệt độ (TO NHẤT) - vị trí thứ 2 - font lớn nhất
                var nhietDoLabel = new Label
                {
                    Text = nhietDo,
                    Font = new Font("Segoe UI", 28F, FontStyle.Bold), // Font lớn nhất
                    ForeColor = Color.White,
                    BackColor = Color.Transparent,
                    TextAlign = ContentAlignment.MiddleCenter,
                ...
                // 3. Label thời tiết (mô tả) - vị trí thứ 3 - đảm bảo hiển thị đầy đủ
                var trangThaiLabel = new Label
                {
                    Text = trangThai,
                    Font = new Font("Segoe UI", 10F),
                ...
                {
                    Text = icon,
                    Font = new Font("Segoe UI Emoji", 48F), // Icon to nhất
                    ForeColor = Color.White,
                    BackColor = Color.Transparent,
                    TextAlign = ContentAlignment.MiddleCenter,
